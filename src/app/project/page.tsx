  ...
  return (
    <main>
      <div className="flex flex-col mx-auto w-full md:w-3/4 lg:w-1/2 px-4">
        ...
        <div className="flex flex-col gap-6 mt-8">
            <Link key={1} href={`/project/${2}`} className="group block rounded-xl border-2 border-mint/40 bg-white p-6 shadow-sm transition-all hover:border-teal hover:shadow-md">
        ...
        <div className="flex flex-col gap-6 mt-8">
            <Link key={1} href={`/project/${3}`} className="group block rounded-xl border-2 border-mint/40 bg-white p-6 shadow-sm transition-all hover:border-teal hover:shadow-md">
              <h2 className="text-2xl font-semibold text-baltic group-hover:text-teal transition-colors">Project Title</h2>
              <p className="mt-2 text-baltic/70">Project Content</p>
            </Link>
        </div>
